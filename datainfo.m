...
subjects(1).session(1).dataset = [datadir, 'sub01/meg01/3016045.07_matves_001_001/20150609matves01_1200hz_20150609_01.ds'];
subjects(1).session(1).icacomp = [7 29 36];
% subjects(1).session(1).icacompLP = []; %only a jump, no ecg
subjects(1).session(2).dataset = [datadir, 'sub01/meg02/3016045.07_matves_001_002/matves01b_1200hz_20150610_01.ds'];
subjects(1).session(2).icacomp = [7 33 50];
% subjects(1).session(2).icacompLP = [];%no ecg
subjects(1).session(3).dataset = [datadir, 'sub01/meg03/3016045.07_matves_001_003/301604507matves013_1200hz_20150611_01.ds'];
...
subjects(9).session(1).dataset = [datadir, 'sub09/meg03/301604507matves091_1200hz_20150727_01.ds'];
subjects(9).session(1).icacomp = [15 19];
% subjects(9).session(1).icacompLP = [];
subjects(9).session(2).dataset = [datadir, 'sub09/meg03/301604507matves092_1200hz_20150728_01.ds'];
...
subjects(10).session(2).dataset = [datadir, 'sub10/meg02/session2/301604507matves102_1200hz_20150811_01.ds'];
